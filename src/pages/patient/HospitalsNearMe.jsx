...
export default function HospitalsNearMe() {
  ...
  function flyTo(h) {
    ...
    if (leafletMap.current) {
      leafletMap.current.flyTo([h.lat, h.lng], 16, { duration: 1 })
    }
  }

  function openDirections(h) {
    const url = `https://www.google.com/maps/dir/?api=1&destination=${h.lat},${h.lng}&travelmode=driving`
                    ...
                    <div className="flex items-start gap-3">
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <div className="flex items-center gap-2 mt-1 flex-wrap">
                          ...
                          {h.emergency && (
                            <span className="text-xs text-red-400 font-semibold">🚨 Emergency</span>
                          )}
                        </div>
                        ...
                        <div className="flex gap-2 mt-3">
                          ...
                          <a
                            href={`https://www.google.com/maps/search/?api=1&query=${encodeURIComponent(h.name)}&center=${h.lat},${h.lng}`}
                            target="_blank"
        ...
        <div className="mt-6 bg-red-500/5 border border-red-500/20 rounded-2xl p-4 flex items-start gap-3">
          ...
          <div>
            ...
            <p className="text-red-400/70 text-xs mt-0.5">
              Call <span className="font-bold text-red-300">108</span> (Ambulance) or <span className="font-bold text-red-300">112</span> (National Emergency) immediately. Do not drive yourself to the hospital in a serious emergency.
            </p>
          </div>
        </div>
      </main>
